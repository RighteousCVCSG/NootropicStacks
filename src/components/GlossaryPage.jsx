...
const glossaryTerms = [
  ...
  { term: 'Ashwagandha', definition: 'Withania somnifera — an Ayurvedic adaptogen with robust clinical evidence for reducing cortisol, lowering anxiety, and improving sleep quality. KSM-66 and Sensoril are the most studied standardized extracts, each with distinct clinical profiles.', tags: ['compound', 'adaptogen'] },
  { term: 'Bacopa Monnieri', definition: 'An Ayurvedic herb with some of the strongest clinical evidence for memory enhancement. Its active compounds (bacosides) improve memory consolidation and reduce anxiety after 8-12 weeks of consistent use. Standardized to 50% bacosides.', tags: ['compound', 'adaptogen'] },
  { term: 'L-Theanine', definition: 'An amino acid found naturally in green tea that promotes relaxed alertness by increasing alpha brain wave activity. When paired with caffeine (2:1 ratio), it reduces jitteriness while enhancing focus. Suntheanine is the most clinically studied branded form.', tags: ['compound'] },
  { term: 'Lion\'s Mane', definition: 'Hericium erinaceus — a medicinal mushroom that stimulates Nerve Growth Factor (NGF) and BDNF, supporting neuroplasticity and long-term brain health. Active compounds include erinacines (mycelium) and hericenones (fruiting body). Effects are cumulative over 4-8 weeks.', tags: ['compound', 'mushroom'] },
  { term: 'Melatonin', definition: 'A hormone produced by the pineal gland that regulates sleep-wake cycles. Supplemental melatonin (0.5-3mg) can help reset circadian rhythms and reduce sleep onset latency. Higher doses (3-10mg) are no more effective than 0.5mg for most people and may cause next-day grogginess.', tags: ['compound', 'hormone'] },
  { term: 'Rhodiola Rosea', definition: 'A Scandinavian/Arctic adaptogen with strong evidence for reducing mental fatigue, improving performance under stress, and supporting mood. Active compounds rosavins and salidroside work through HPA axis modulation. Best taken in the morning on an empty stomach.', tags: ['compound', 'adaptogen'] },
  { term: 'Anxiolytic', definition: 'A substance that reduces anxiety. Several nootropics have anxiolytic properties including L-Theanine, Ashwagandha, Bacopa Monnieri, Magnesium (glycinate/threonate), and GABAergic compounds. Non-sedating anxiolytics are prized in nootropic stacks for maintaining calm without drowsiness.', tags: ['concept'] },
  { term: 'Huperzine A', definition: 'A compound derived from Chinese club moss (Huperzia serrata) that inhibits acetylcholinesterase, the enzyme that breaks down acetylcholine. Effective for memory enhancement; typically cycled 2 weeks on / 2 weeks off due to its long half-life (~10-14 hours).', tags: ['compound'] },
  { term: 'Adrafinil', definition: 'A prodrug to Modafinil that is metabolized in the liver to produce wakefulness-promoting effects. Formerly sold OTC as a nootropic; discontinued by its manufacturer but still circulates as a research chemical. Requires liver metabolism, so effects take 45-60 minutes to onset.', tags: ['compound', 'stimulant'] },
  { term: 'Placebo', definition: 'An inert substance used as a control in clinical trials. A significant proportion of nootropic effects in poorly-controlled studies may be placebo-driven — making double-blind, placebo-controlled RCTs the gold standard for evaluating supplement efficacy. Open-label studies should be interpreted with caution.', tags: ['concept'] },
];
