    ...
    <>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-10 p-3 bg-primary-050 border border-primary-300 rounded-md text-primary-900 text-center">
          ...
          <p className="text-primary-700 text-sm mb-4">Use our free Stack Builder to combine the supplements that match your goals, check interactions, and get a personalized Stack Score.</p>
