// FAQ data shared between the React FAQPage and the build-time SEO prerender.
// Update this file to change FAQ copy on both the SPA and the prerendered HTML.
